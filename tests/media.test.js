  ...
  beforeEach(async () => {
    await MediaModel.insertMany([
      ...
      },
      {
        title: 'Luca',
        description:
          'Filme sobre uma criança marítima descobrindo um novo mundo na superfície',
        type: 'movie',
        releaseYear: 2021,
        genre: 'Animação',
      },
  ...
  describe('createNewMedia', () => {
    it('cria uma media com sucesso', async () => {
      const media = {
        ...
        description:
          'Um homem que nasceu velho e fica novo a medida que os anos passam',
        type: 'movie',
        releaseYear: 2008,
        genre: 'Drama',
      };
    ...
    it('falha se o título estiver vazio', async () => {
      ...
      await expect(mediaService.createNewMedia(media)).rejects.toThrow(
        /Título/
      );
    });
